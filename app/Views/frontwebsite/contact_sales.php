...
<div class="container text-white" id="pricing_plans">
    <div class="row">
      <!-- Pricing Plan 1 - Single Tour -->
      <div class="col-md-4">
        <div class="pricing-plan">
          <h3>Single <br>Tour</h3>
          <p>One virtual tour, perfect for small businesses looking to explore AR/VR.</p>
          <p>If you own an AirBnb flat, this is the way to go </p>
          <a href="https://buy.stripe.com/test_3cscQKaGSawMcFO7ss" class="btn btn-sm btn-info" onclick="redirectToStripe('YOUR_STRIPE_LINK_1')">Choose Plan</a>
        </div>
      </div>

      <!-- Pricing Plan 2 - Three Tours Pack -->
      <div class="col-md-4">
        <div class="pricing-plan">
          <h3>Three <br>Tours Pack</h3>
          <p>Three virtual tours, perfect for small businesses looking to explore AR/VR.</p>
          <p>If you own an AirBnb flat, this is the way to go </p>
          <a href="https://buy.stripe.com/test_3cscQKaGSawMcFO7ss" class="btn btn-sm btn-info" onclick="redirectToStripe('YOUR_STRIPE_LINK_1')">Choose Plan</a>
        </div>
      </div>

      <!-- Pricing Plan 3 - 3 or more Tours -->
      <div class="col-md-4">
        <div class="pricing-plan">
          <h3>3 or more <br>tours</h3>
          <p>One virtual tour, perfect for small businesses looking to explore AR/VR.</p>
          <p>If you own an AirBnb flat, this is the way to go </p>
          <button class="btn btn-sm btn-info" onclick="scrollToSection('contact')">Complete the form below</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
        <div class="col-lg-6">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d89103.94652729103!2d21.134189584758687!3d45.74115474050871!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4745677dcb0fb5a7%3A0x537faf6473936749!2sTimi%C8%99oara!5e0!3m2!1sro!2sro!4v1705776596543!5m2!1sro!2sro" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>       </div>
          <!-- end holder --> 
        </div>
        <!-- end map -->
        </div>
...
<script>
    ...
    function scrollToSection(sectionId) {
      // Scroll to the specified section with the given ID
